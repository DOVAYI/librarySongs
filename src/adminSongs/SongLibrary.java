...
public abstract class SongLibrary {
    ...
    public ArrayList<Song> list() {
        ...
        song.add(new Song("te amare", "1", LocalDate.of(2008, Month.FEBRUARY, 23), 4.15, "baladas", "foto.png",
                " musica romantica"));
        song.add(new Song("Dile a Ella", "2", LocalDate.of(2013, Month.JANUARY, 12), 4.28, "reggeaton", "foto2.png",
                " reggeaton don omar"));
        ...
        song.add(new Song("tu pirata", "4", LocalDate.of(2008, Month.JULY, 2), 3.48, "baladas", "foto4.png",
                " musica romantica"));
        song.add(new Song("AL natural", "5", LocalDate.of(2010, Month.OCTOBER, 23), 3.24, "reggeaton", "foto5.png",
        ...
        song.add(new Song("tal para cual", "7", LocalDate.of(2017, Month.APRIL, 7), 5.15, "salsa", "foto7.png",
                " Joe Arroyo"));
        song.add(new Song("Pueden pasar 3000 años", "8", LocalDate.of(2010, Month.NOVEMBER, 13), 4.12, "baladas",
        ...
        song.add(new Song("El perdedor", "10", LocalDate.of(2010, Month.JUNE, 19), 4.23, "salsa", "foto10.png",
                "Chichi boys"));
        song.add(new Song("La boigrafia", "11", LocalDate.of(2008, Month.MAY, 15), 4.46, "vallenato", "foto11.png",
                " Diomez Diaz"));
